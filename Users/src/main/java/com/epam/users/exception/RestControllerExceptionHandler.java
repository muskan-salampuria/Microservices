...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ExceptionResponse> handleTaskIDNotFound(UserNotFoundException ex,WebRequest req) {
	...
	public ResponseEntity<ExceptionResponse> handleTaskIDNotFound(UsernameExistsException ex,WebRequest req) {
		ExceptionResponse error = new ExceptionResponse(new Date().toString(),HttpStatus.BAD_REQUEST.name(),ex.getMessage(),req.getDescription(false));
		return new ResponseEntity<>(error,HttpStatus.BAD_REQUEST);
	}
}
